  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-800 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className=" text-2xl">$63,598.69</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
        ...
        <div className="cards flex m-3 flex-wrap justify-center gap-1 items-center ">
            ...
            >
              ...
              <p className="mt-3">
                ...
                <span className={`text-sm text-${item.pcColor} ml-2`}>
                  {" "}
                  {/* there is a bug here in setting the dyanmic color string */}
                  {item.percentage}
                </span>
              </p>
